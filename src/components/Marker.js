...
function Marker({ price, onMarker, name, rating }) {
  ...
  return (
    <div>
      {isHover && (
        <div className="inline-block absolute z-10 w-64 text-sm font-light text-gray-500 rounded-lg border border-gray-200 shadow-sm -translate-x-2/4 -translate-y-[95px] transition-opacity duration-300 text-gray-400 border-gray-600 bg-gray-800">
      ...
      <img
        ...
        className="cursor-pointer hover:scale-150 transition hover:z-10"
      />
    </div>
  );
}
